...
import { getAllTags, getElementByTagSlug, sortTagsByCount } from "@/lib/utils";
...
export function TagPageProject({ params }: TagPageProps) {
	...
	const allProjects = getElementByTagSlug(projects, tag);
	const displayPosts = allProjects.filter((project) => project.published);
